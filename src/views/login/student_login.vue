<template>
  ...
  >
    <!-- <div id="title" class="animated fadeInDownBig">廉江中学后台管理系统</div> -->
    <!-- <el-card
      shadow="always"
      class="box-class animated fadeInLeftBig"
    >
      <el-form
        ref="form"
        :rules="rules"
      ...
      >
        ...
        <el-form-item prop="password">
          <el-input
            ...
            type="password"
            prefix-icon="el-icon-unlock el"
          />
        </el-form-item>
        <el-form-item class="white px_14 ">
          下次自动登录<el-checkbox v-model="form.loginDirect" />
          <router-link
            class="white right"
            to="login"
          >
